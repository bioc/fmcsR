...
\begin{figure}[bthp]
  \centering
    ...
    \includegraphics[width=10cm]{emp.pdf}
...
\begin{figure}[bthp]
  \centering
    ...
    \includegraphics[width=8cm]{bb.pdf}
